...
function MetricPill({ label, value, highlight }) {
  return (
    <div
      className={`flex flex-col items-center px-3 py-2.5 rounded-xl text-center transition-all duration-200 hover:scale-105 ${
        highlight
...
function ModelRow({ model, acc, prec, rec, f1, selected, delay, inView }) {
  return (
    <div
      className={`flex items-center gap-3 p-4 rounded-xl transition-all duration-300 border group hover:-translate-y-0.5 hover:shadow-md ${
        selected
      ...
      <header className="sticky top-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
          ...
          >
            ...
            <span className="font-display font-semibold text-slate-900 dark:text-white text-sm">CardioAI</span>
          </button>
          ...
          >
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold mb-6"
                ...
                Final Year Project · AI/ML · Healthcare
              </div>
              <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight max-w-3xl">
                Building an AI-Powered<br />Cardiovascular Risk Prediction System
              </h1>
              <p className="text-blue-100/75 text-base sm:text-lg max-w-2xl mb-8 leading-relaxed">
                From raw clinical data to a production-ready machine learning system — dataset validation, iterative model experimentation, and explainable AI integration.
              </p>
          ...
          <section id="decision" ref={decRef}
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex items-center gap-0 overflow-x-auto">
                {[
                  { phase: "Phase 1", choice: "XGBoost",             reason: "Strong performance + SHAP",           color: "#f59e0b" },
