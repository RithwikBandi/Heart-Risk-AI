      ...
      {result && !loading && (
        <section id="result-section" className="space-y-5 animate-fade-up">
          ...
          <div className="flex items-start gap-3 px-4 py-3 rounded-xl text-xs text-amber-800"
            ...
            <p>
              <strong>Medical Disclaimer:</strong> This AI assessment is for educational purposes only and does not replace professional medical advice. Always consult a qualified healthcare provider for medical decisions.
            </p>
          </div>
        </section>
      )}
